...
export async function PUT(
  ...
  try {
    ...
    const { data: existing } = await (context.supabase.from("care_plan_tasks") as any)
      .select("*")
      .eq("id", taskId)
      .eq("is_deleted", false)
      .single();
    ...
    // care_plan_tasks has no organization_id of its own - verify the
...
export async function DELETE(
  ...
  try {
    ...
    await (context.supabase.from("care_plan_tasks") as any)
