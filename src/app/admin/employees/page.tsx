...
export default function EmployeesPage() {
  ...
  const fetchEmployees = useCallback(
    ...
    [pagination.limit, debouncedSearch, status, sortBy, sortOrder]
  );

  useEffect(() => {
    fetchEmployees(1);
  }, [debouncedSearch, status, sortBy, sortOrder, fetchEmployees]);
              ...
              <tbody className="divide-y dark:divide-gray-700">
                {employees.map((employee) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm">
                      <Badge variant="info">{employee.employment_type}</Badge>
                    </td>
                    <td className="px-6 py-4 text-sm">
